...
class heatEquationBarre : public heatEquationBase<1> {
    ...
    public:
        ...
        */
        ...
        /*!
        * @brief Fonction qui retourne la solution de l'équation de la chaleur
        */
        std::vector<double> getSolution() const;

        /*!
        * @brief Fonction qui retourne le maillage en espace
        */
        std::vector<double> getXi() const;
        ...
        */
        ...
        /*!
        * @brief Fonction qui retourne la taille de la barre
        */
        double getL() const;
